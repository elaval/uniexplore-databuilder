...
var outdir="./data/areas/";
var mainfilename = "./data/areas.txt";

//var filename = "./dummy.txt";
var categoryAttribute = "area";
var data = [];
...
processor.cursosSave = function(data, fields) {
	...
	fs.writeFileSync(mainfilename, outdata);
